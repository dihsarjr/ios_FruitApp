...
let fruitData:[FruitModel] = [
    FruitModel(
        ...
        image: "blueberry",
        gradiantColors: [Color.blue.opacity(0.5), Color.blue],
        description: """
    ...
    FruitModel(
        ...
        image: "strawberry",
        gradiantColors: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
        description: """
    ...
    FruitModel(
        ...
        image: "lemon",
        gradiantColors: [Color("ColorLemonLight"), Color("ColorLemonDark")],
        description: """
    ...
    FruitModel(
        ...
        image: "plum",
        gradiantColors: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
    ...
    FruitModel(
        ...
        image: "lime",
        gradiantColors: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
    ...
    FruitModel(
        ...
        image: "pomegranate",
        gradiantColors: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pear",
        gradiantColors: [Color("ColorPearLight"), Color("ColorPearDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "gooseberry",
        gradiantColors: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "mango",
        gradiantColors: [Color("ColorMangoLight"), Color("ColorMangoDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "watermelon",
        gradiantColors: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "cherry",
        gradiantColors: [Color("ColorCherryLight"), Color("ColorCherryDark")],
        description: """
    ...
    FruitModel(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "grapefruit",
        gradiantColors: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
        description: """
    ...
    FruitModel(
        ...
        image: "apple",
        gradiantColors: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
